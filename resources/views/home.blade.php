                    ...
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide">
                            <div class="home1__slide">
                                ...
                                <a href="" class="c-btn3"> Tìm hiểu thêm 
                                    <svg width="47" height="46" viewBox="0 0 47 46" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M45.524 23C45.524 35.4262 35.4453 45.5 23.012 45.5C10.5787 45.5 0.5 35.4262 0.5 23C0.5 10.5738 10.5787 0.5 23.012 0.5C35.4453 0.5 45.524 10.5738 45.524 23Z" stroke="#EEEBE2" />
                                        <path
...
<section class="home3">
    <div class="l-container">
        <div class="home3__inner">
            ...
            <p>Bất động sản nông nghiệp là xu thế "chiếm sóng thị trường" với các cơ chế chính sách đang mở cửa. Aking Village tiên phong xây dựng <span>Mô hình đầu tư Bất động sản Nông nghiệp và Nông sản</span> - loại hình đầu tư đầy tiềm năng và cơ chế pháp lý đầy đủ - giúp các nhà đầu tư dễ dàng tiếp cận thị trường BĐS nông nghiệp có khả năng sinh lời vững vàng trước mọi biến động.</p>
            <a href="/" class="c-btn1 u-btn">Đầu tư ngay</a>
        </div>
    </div>
</section>
                ...
                <div class="c-row__col">
                    <div class="u-center">
                        <svg width="42" height="43" viewBox="0 0 42 43" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M21 5.90778e-06C16.8466 5.90778e-06 12.7865 1.26096 9.33303 3.62341C5.8796 5.98586 3.18798 9.3437 1.59854 13.2723C0.00909892 17.2009 -0.406771 21.5238 0.403518 25.6944C1.21381 29.865 3.21386 33.696 6.15076 36.7028C9.08767 39.7096 12.8295 41.7573 16.9031 42.5869C20.9767 43.4165 25.1991 42.9907 29.0364 41.3634C32.8736 39.7361 36.1534 36.9804 38.4609 33.4448C40.7684 29.9091 42 25.7523 42 21.5C42.002 18.676 41.4603 15.8793 40.4056 13.2698C39.351 10.6604 37.8042 8.28941 35.8538 6.29254C33.9034 4.29566 31.5875 2.71206 29.0388 1.63233C26.49 0.552596 23.7583 -0.00208828 21 5.90778e-06ZM33.2474 15.6074L18.0514 31.2148C17.8752 31.4009 17.6647 31.5492 17.4321 31.6513C17.1995 31.7533 16.9494 31.8071 16.6963 31.8094C16.2123 31.8094 15.68 31.6112 15.3412 31.2148L7.79161 23.4854C7.42569 23.1109 7.22008 22.6029 7.22 22.0732C7.21992 21.5435 7.42538 21.0354 7.79118 20.6608C8.15698 20.2862 8.65316 20.0757 9.17056 20.0756C9.68797 20.0755 10.1842 20.2858 10.5501 20.6603L16.6479 27.0033L30.4889 12.8292C30.6685 12.641 30.883 12.4914 31.1199 12.3893C31.3567 12.2872 31.6111 12.2346 31.8681 12.2346C32.1252 12.2346 32.3796 12.2872 32.6164 12.3893C32.8533 12.4914 33.0678 12.641 33.2474 12.8292C34.0252 13.5724 34.0252 14.8111 33.2474 15.6039V15.6074Z" fill="#63A940"/>
                        </svg>
                    </div>
                    <p class="c-desc">Nắm giữ trong tay <span>1000m2 đất</span> và <span>4000 cây dứa</span> cho mỗi suất đầu tư</p>
                </div>
                <div class="c-row__col">
                    <div class="u-center">
                        <svg width="44" height="45" viewBox="0 0 44 45" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <g clip-path="url(#clip0_731_1551)">
                                <path d="M4.39612 20.9895C2.94585 20.8504 1.53767 20.7114 0 20.6187C0.906416 13.0168 4.35079 7.12677 10.741 3.23647C17.3579 -0.796198 24.2466 -0.935255 31.3199 2.12401C30.6854 3.51459 30.0509 4.8555 29.4585 6.20303C17.5853 0.687083 5.16657 9.49406 4.39612 20.9895ZM39.3838 19.4168C40.1542 24.6546 39.1118 29.4323 35.9394 33.5543C32.8122 37.6797 28.6427 39.951 23.5215 40.5072C23.6574 41.9905 23.7481 43.4274 23.884 44.8643C34.5798 44.4902 46.0491 33.5047 43.6892 18.5791C42.2843 18.9036 40.8793 19.1354 39.3838 19.4135V19.4168ZM4.35079 24.1415C2.99117 24.2805 1.58623 24.3732 0.135962 24.5123C0.453208 33.6884 8.2937 44.0267 20.0771 45.0001C20.2131 43.5168 20.349 42.0799 20.4397 40.6429C11.2396 39.0686 5.8917 33.5974 4.35079 24.1415ZM35.9847 11.5336C37.0724 12.9705 37.9335 14.5961 38.6133 16.3542C39.9729 15.8444 41.3325 15.3345 42.7407 14.8246C41.1092 10.3748 38.4353 6.85197 34.6736 4.07082C33.8093 5.27598 32.9935 6.48115 32.1292 7.73266C33.5859 8.84512 34.897 10.0983 35.9847 11.5336Z" fill="#63A940"/>
                            </g>
                            <defs>
